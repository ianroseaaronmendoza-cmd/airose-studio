            ...
            <Card>
              <CardContent>
                ...
                <ul className="space-y-2 text-slate-300">
                  <li className="flex items-center gap-3"><Music size={16} /> Music & small recordings</li>
                  <li className="flex items-center gap-3"><Book size={16} /> Stories & poems</li>
                  <li className="flex items-center gap-3"><Sparkles size={16} /> Curiosity-built apps</li>
                  <li className="flex items-center gap-3"><Heart size={16} /> Ministry work</li>
                </ul>
              </CardContent>
            </Card>
          </motion.div>
